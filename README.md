...
A gradle plugin with task to generate assertions using [AssertJ Assertions Generator](http://joel-costigliola.github.io/assertj/assertj-assertions-generator.html), forked from fhermansson/assertj-generator-gradle-plugin via dimamura/assertj-generator-gradle-plugin, and published as https://plugins.gradle.org/plugin/com.waftex.assertj-generator. This repository provides dependency updates and minimal maintenances. If you have no reason, you should use the original fhermansson/assertj-generator-gradle-plugin.
